use crate::{
    ir::{Node, NodeType},
    node::{
        argmax::argmax_update_outputs, argmin::argmin_update_outputs, cast::cast_update_outputs, comparison::elementwise_comparison_outputs, concat::concat_update_outputs, constant::constant_update_outputs, constant_of_shape::constant_of_shape_update_output, deform_conv::deform_conv_update_outputs, depth_to_space::depth_to_space_update_outputs, expand::expand_update_outputs, flatten::flatten_update_outputs, gather::gather_update_outputs, gemm::gemm_output_shape, linear::linear_update_outputs, matmul::matmul_update_outputs, one_hot::one_hot_output_shape, random::random_update_output, random_like::random_like_update_output, range::range_update_outputs, reduce_max::reduce_max_update_outputs, reduce_mean::reduce_mean_update_outputs, reduce_min::reduce_min_update_outputs, reduce_prod::reduce_prod_update_outputs, reduce_sum::reduce_sum_update_outputs, reshape::reshape_update_outputs, shape::shape_update_outputs, slice::slice_update_output_rank, space_to_depth::space_to_depth_update_outputs, split::split_update_outputs, squeeze::squeeze_update_output, topk::top_k_update_output, unsqueeze::unsqueeze_update_output, where_op::where_update_outputs
    },
...
pub fn rank_inference(node: &mut Node) {
    ...
    match node.node_type {
        ...
        NodeType::DeformConv => deform_conv_update_outputs(node),
